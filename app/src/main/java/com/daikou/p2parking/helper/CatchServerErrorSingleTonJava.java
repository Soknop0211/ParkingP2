...
import com.daikou.p2parking.base.ApiError;
import com.daikou.p2parking.base.ResponseErrorBody;
import com.daikou.p2parking.data.call_back.BaseListener;
...
public class CatchServerErrorSingleTonJava {
    ...
    static String LocalizeException = "LocalizeException";
    ...
    public static void catchError(Context context, Throwable e, BaseListener baseListener) {
        ...
        if (e instanceof HttpException) {
            ...
            messagesHash.put(LocalizeException, message.toString());
